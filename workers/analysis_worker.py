...
from engine.llm_client import InferenceCancelled
        ...
        try:
            ...
            if tier == "minor":
                ...
                if layout_regions and ocr_boxes:
                    try:
                        from engine.layout_analyzer import organize_ocr_text
                ...
                if ocr_boxes:
                    try:
                        from engine.layout_analyzer import organize_ocr_text, cluster_ocr_layout
                        screen_w, screen_h = capture.image.size
                    ...
                    if kw in searchable:
                        ...
                        try:
                            if settings.webhook_enabled and settings.webhook_url:
                                from integrations.webhooks import fire
                                fire("bookmark", {
                                    "activity_id": activity_id,

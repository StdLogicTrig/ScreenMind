...
async def list_agents():
    ...
    from engine.agent_runner import discover_agents, get_agent_log
...
async def agent_log():
    ...
    from engine.agent_runner import get_agent_log
...
output: local
"""
from screenmind_sdk import get_recent_activity, notify
